...
-- esqueci do id_raca, como já criei a tabela, irei adicionar logo a baixo
-- esqueci do telefone, como já criei a tabela, irei adicionar logo a baixo
);
...
--
-- Adicionar coluna id_raca
alter table cadastro_cliente
add id_raca int after telefone;
-- Adicionar restrição de chave estrangeira para id_raca
alter table cadastro_cliente
add constraint id_raca foreign key (id_raca) references racas(id_raca);
--
-- Adicionar coluna id_escolaridade
alter table cadastro_cliente
add id_escolaridade int after id_raca;
-- Adicionar restrição de chave estrangeira para id_escolaridade (supondo que exista uma tabela escolaridades)
alter table cadastro_cliente
add constraint id_escolaridade foreign key (id_escolaridade) references escolaridades(id_escolaridade);

-- Inserindo clientes na tabela cadastro_cliente
insert into cadastro_cliente (cpf, rg, nome, id_cidade, id_sexo, id_nacionalidade, telefone, id_raca, id_escolaridade) VALUES
('201.023.031-10', '20242001-6', 'Agatha Marie', 51, 1, 1, '+55 (67) 99206-8038', 5, 3),
('201.101.031-10', '20242001-4', 'Alysson Bryan', 51, 2, 1, '+55 (67) 99201-3010', 5, 5),
('123.456.789-01', '12345678-9', 'João Pedro', 15, 2, 1, '+55 (41) 98765-4321', 1, 8),
('987.654.321-09', '98765432-2', 'Maria Silva', 18, 1, 1, '+55 (21) 99765-4322', 2, 7),
('456.789.012-34', '45678901-3', 'Pedro Henrique', 8, 2, 1, '+55 (62) 98765-4323', 3, 6),
('654.321.098-76', '65432109-4', 'Ana Luiza', 7, 1, 1, '+55 (85) 98765-4324', 4, 5),
('321.098.765-43', '32109876-5', 'Luiz Felipe', 12, 2, 1, '+55 (31) 98765-4325', 5, 4),
('098.765.432-12', '09876543-6', 'Beatriz Souza', 4, 1, 1, '+55 (77) 98765-4326', 1, 3),
('789.012.345-67', '78901234-7', 'Gabriel Oliveira', 2, 2, 2, '+55 (91) 98765-4327', 2, 2),
('567.890.123-89', '56780127-8', 'Julia Martins', 11, 1, 1, '+55 (81) 98765-4328', 3, 1),
('890.123.456-01', '89201345-9', 'Rafael Alves', 13, 2, 1, '+55 (43) 98765-4329', 4, 8),
('234.567.890-23', '23456789-0', 'Isabella Lima', 19, 1, 1, '+55 (51) 98765-4330', 5, 7),
('345.678.901-45', '34567890-1', 'Matheus Costa', 6, 2, 1, '+55 (71) 98765-4331', 1, 6),
('678.901.234-56', '67890123-2', 'Larissa Santos', 22, 1, 1, '+55 (95) 98765-4332', 2, 5),
('901.234.567-78', '90123456-3', 'Vinicius Ferreira', 26, 2, 1, '+55 (63) 98765-4333', 3, 4),
('012.345.678-90', '01234567-4', 'Camila Pereira', 5, 1, 1, '+55 (27) 98765-4334', 4, 3),
('456.789.012-34', '45678901-5', 'Felipe Castro', 3, 2, 2, '+55 (21) 98765-4335', 5, 2),
('987.654.321-09', '98765432-6', 'Aline Souza', 17, 1, 1, '+55 (83) 98765-4336', 1, 1),
('123.456.789-01', '12345678-7', 'João Victor', 20, 2, 1, '+55 (51) 98765-4337', 2, 8),
('654.321.098-76', '65432109-8', 'Gabriela Silva', 10, 1, 1, '+55 (85) 98765-4338', 3, 4);
